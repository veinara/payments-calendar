						...
						<div class="row align-items-center">
							...
							<div class="col-lg order-lg-first">
								<ul class="nav nav-tabs border-0 flex-column flex-lg-row">
									<!--<li class="nav-item">
										<a href="<?php echo base_url();?>" class="nav-link <?php if($this->uri->segment(1)==""){echo "active";}?>"><i class="fe fe-home"></i> Home</a>
									</li>-->
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu dropdown-menu-arrow">
											...
											<a href="<?php echo site_url('inv/create_inv');?>" class="dropdown-item ">Create invoice</a>
											<?php endif;?>
										</div>
									</li>
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu dropdown-menu-arrow">
											...
											<a href="<?php echo base_url();?>auth/create_group" class="dropdown-item ">Create group</a>
										</div>
									</li>
									<?php endif; ?>
								</ul>
